...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/vclong/Workspace/ParkNexus/api/src/db/prismaClient",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "src/db/prismaClient/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/db/prismaClient/schema.prisma")
